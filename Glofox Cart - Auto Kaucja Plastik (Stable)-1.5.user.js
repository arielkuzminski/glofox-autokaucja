...
// @updateURL    https://raw.githubusercontent.com/arielkuzminski/glofox-autokaucja/master/Glofox%20Cart%20-%20Auto%20Kaucja%20Plastik%20(Stable)-1.5.user.js
// @downloadURL  https://raw.githubusercontent.com/arielkuzminski/glofox-autokaucja/master/Glofox%20Cart%20-%20Auto%20Kaucja%20Plastik%20(Stable)-1.5.user.js
// ==/UserScript==
...
(function () {
  ...
  async function setDepositQuantity(lineItem, qty) {
    ...
    // Ant renderuje dropdown w portalu na body
    ...
    // Zamknij dropdown jeśli nie znaleziono opcji
  ...
  const cartSyncObserver = new MutationObserver(() => {
    ...
    syncDebounceTimer = setTimeout(() => {
      if (!isAddingDeposit) syncDepositQuantity();
    }, 800);
  });
  ...
  console.log("[GLOFOX] Auto-Kaucja Plastik (Stable) v1.5 aktywna ✅");
})();
